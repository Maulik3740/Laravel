...
<head>
    ...
    src: url('path/to/rupee-font.woff') format('woff');
}

body {
    font-family: 'RupeeFont', 'Arial', sans-serif;
}
...
<body>
    ...
    <div class="text-center">
        ...
        <p>
            Thank you for purchasing with {{ $appSetting->website_name ?? "Funda Ecommerce"}}
        </p>
    </div>
        ...
        <thead>
            <tr>
                ...
                <th width="50%" colspan="2" class="text-end company-data">
                    ...
                    <span>Zip code : {{ $appSetting->pincode }}</span> <br>
