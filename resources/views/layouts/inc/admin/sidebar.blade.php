<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
        ...
        <li class="nav-item {{ Request::is('admin/category*') ? 'active' : '' }} cursor-pointer"
            style="cursor: pointer;">
            <a class="nav-link " data-bs-toggle="collapse" data-bs-target="#basic"
                aria-expanded="{{ Request::is('admin/category*') ? 'true' : 'false' }}" aria-controls="basic">
        ...
        <li class="nav-item {{ Request::is('admin/products*') ? 'active' : '' }}" style="cursor: pointer;">
            <a class="nav-link" data-bs-toggle="collapse" data-bs-target="#product"
                aria-expanded="{{ Request::is('admin/products*') ? 'true' : 'false' }}" aria-controls="product">
            ...
            <div class="collapse {{ Request::is('admin/products*') ? 'show' : '' }}" id="product">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item"> <a
                            ...
                            href="{{ url('admin/products') }}">View Product</a></li>
                </ul>
            </div>
        </li>
        ...
        <li class="nav-item {{ Request::is('admin/users*') ? 'active' : '' }}" style="cursor: pointer;">
            <a class="nav-link" data-bs-toggle="collapse" data-bs-target="#auth"
        ...
        <li class="nav-item {{ Request::is('admin/contact') ? 'active' : '' }}">
            <a class="nav-link" href="{{ url('admin/contact') }}">
                ...
                <span class="menu-title">Contact Requestes</span>
            </a>
        </li>
