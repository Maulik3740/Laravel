...
@push('scripts')
    <script
        src="https://www.paypal.com/sdk/js?client-id=AUeWIVyInS9sEwmVLnLBUf0A4DEkE8QQGXtji5TBbW_pQv41X9GwO6c7-CJyRO6SMASvkHA6hYkADjXp&currency=USD">
    </script>
        ...
        paypal.Buttons({
            ...
            createOrder: function(data, actions) {
                ...
                return actions.order.create({
                    purchase_units: [{
                        amount: {
                            value: '{{ $this->totalProductAmount }}', // Set the amount you want to charge
                            currency_code: 'USD' // Set the currency code (e.g., USD for US Dollars)
                        }
                    }]
                });
            },
